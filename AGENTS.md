...
This file is the quick-reference operating contract for rama-http-backend-kotlin. The longer
...
rama-http-backend-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rama-http-backend`](https://crates.io/crates/rama-http-backend). Upstream Rust is the behavioral oracle while the
