...
kotlin {
    ...
    val xcf = XCFramework("RamaHttpBackend")
    ...
    swiftExport {
        moduleName = "RamaHttpBackend"
        flattenPackage = "io.github.kotlinmania.ramahttpbackend"
    }

    android {
        namespace = "io.github.kotlinmania.ramahttpbackend"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rama-http-backend-kotlin", version.toString())

    pom {
        name.set("rama-http-backend-kotlin")
        description.set("Kotlin Multiplatform port of plabayo/rama - error types and utilities for rama")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rama-http-backend-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rama-http-backend-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rama-http-backend-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rama-http-backend-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    val emptySourceSentinel =
        layout.buildDirectory.file(
            "generated/sources/codeqlCompileJvm/kotlin/io/github/kotlinmania/ramahttpbackend/CodeqlEmptySourceSentinel.kt",
        )
    ...
    doFirst {
        ...
        val sourceFiles =
            sources.files.sortedBy { it.absolutePath }.ifEmpty {
